...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Check if email is available' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns availability status' }),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Login admin user' }),
